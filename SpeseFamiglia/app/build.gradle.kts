...
/**
 * Esegue git nella cartella del progetto (SpeseFamiglia/); stringa vuota se git non è disponibile
...
// pathspec "." limita conteggio e changelog ai soli commit che toccano SpeseFamiglia/.
...
fun generaSorgenteChangelog(): String {
    ...
    return """
        |package com.desideri.spesefamiglia.changelog
        |
...
val generaChangelog = tasks.register("generaChangelog") {
    ...
    doLast {
        val pacchettoDir = File(outputDir.get().asFile, "com/desideri/spesefamiglia/changelog")
        pacchettoDir.mkdirs()
...
android {
    namespace = "com.desideri.spesefamiglia"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.desideri.spesefamiglia"
        minSdk = 26
        targetSdk = 35
    ...
    applicationVariants.all {
        outputs.all {
            ...
            output.outputFileName = "SpeseFamiglia.apk"
        }
    }
