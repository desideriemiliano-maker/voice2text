...
private val RETENZIONE_MS = TimeUnit.DAYS.toMillis(30)
...
/**
 * Stesso registro di Voice2Text (RegistroPromptStore). Registro locale (su file nella cache dell'app, nessun server) delle chiamate a Gemini: prompt
 * inviato e risultato ottenuto (o l'errore). Le voci piu' vecchie di 30 giorni vengono scartate
        ...
        return try {
            ...
            (0 until array.length()).map { indice ->
                ...
                VoceRegistro(
                    ...
                    tipo = runCatching { TipoChiamataGemini.valueOf(obj.getString("tipo")) }.getOrDefault(TipoChiamataGemini.ESTRATTO_CONTO),
