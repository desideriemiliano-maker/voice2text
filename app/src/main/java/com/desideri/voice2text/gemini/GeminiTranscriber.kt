...
private const val PROMPT_TRASCRIZIONE =
    "Ascolta questo audio e restituisci: la trascrizione fedele del parlato in italiano, " +
        "e una stima approssimativa di chi parla basata solo sulla voce (genere, eta', umore, " +
        "tono di voce). Sono stime indicative, non certezze: se un aspetto non e' deducibile " +
        "dalla voce usa 'Non determinabile'."

/**
 * Esito strutturato di una trascrizione: [testo] e' il parlato trascritto, gli altri campi
 * sono stime di Gemini dedotte dalla sola voce (non dati certi) - vanno presentati come tali
 * nell'interfaccia.
 */
...
private fun schemaTrascrizione(): Schema =
    Schema.builder()
        ...
        .required("testoTrascritto", "genere", "eta", "umore", "tonoVoce")
        .build()
